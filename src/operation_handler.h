...
namespace optp
{
	...
	{
	public:
		interfaces::operation_result_shptr handle(interfaces::operation_wptr op) override;
		...
		virtual interfaces::operation_result_shptr operator()(interfaces::operation_wptr operation) = 0; 
